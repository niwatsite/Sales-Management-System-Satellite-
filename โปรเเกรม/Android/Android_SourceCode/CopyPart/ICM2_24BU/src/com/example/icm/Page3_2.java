...
public class Page3_2 extends ActionBarActivity {
Button nextmap;
String sProdPrice1;
String sProdID;
String sProdName;
         ...
         GetData2();
			 ...
			 nextCustSer.setOnClickListener(new View.OnClickListener(){
		 			...
		 			public void onClick(View v) {
		 				Intent it = new Intent(Page3_2.this,Page3_4.class);
			 ...
			 nextmap.setOnClickListener(new View.OnClickListener(){
		 			...
		 			public void onClick(View v) {
		 				Intent it = new Intent(Page3_2.this,MapCurrent.class);
		 				it.putExtra("User_Id", sUser_Id);//User_Id
...
*/
    		...
    		params.add(new BasicNameValuePair("strProd_Num_Count", String.valueOf("0")));
    	//	params.add(new BasicNameValuePair("strProd_Num_Count_Price", String.valueOf(sProdPrice1)));
    	//	params.add(new BasicNameValuePair("strProd_Price_Result", String.valueOf(sProdPrice1)));
			...
			else
			{
				...
				Toast.makeText(Page3_2.this, "ทำรายการเรียบร้อยเเล้ว", Toast.LENGTH_SHORT).show();
				Intent newActivity = new Intent(Page3_2.this,Main.class);
		...
		if (requestCode==123) {
			if (resultCode==RESULT_OK) {
				//get maps
				 ...
				 Toast.makeText(Page3_2.this,lat2+","+lng2, Toast.LENGTH_SHORT).show();
    ...
    public void GetData2()
    {
    	...
    	//String url = "http://10.0.2.2/android/getOrdertID.php";
            	...
            	String resultServer2  = getHttpGet2(url2);
            	result.setText(resultServer2);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.page3_2, menu);
		return true;
	}
				...
				
	{
    	        ...
    	        AlertDialog.Builder dialog = new AlertDialog.Builder(Page3_2.this);
    	        ...
    	        dialog.setPositiveButton("ใช่", new OnClickListener() {
    	            public void onClick(DialogInterface dialog, int which) {
            			Intent newActivity = new Intent(Page3_2.this,Login.class);
            			startActivity(newActivity);
    	                finish();
    	            }
    	        });
