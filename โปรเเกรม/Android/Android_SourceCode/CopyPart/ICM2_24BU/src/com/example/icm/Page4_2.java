...
public class Page4_2 extends ActionBarActivity {
    ...
    public void SearchData2() {
    	gps = new GPSTracker(Page4_2.this); 
        if(gps.canGetLocation()){
        	...
        	Toast.makeText(Page4_2.this, "อุปกรณ์์ของคุณ ปิด GPS", Toast.LENGTH_SHORT).show();
	...
	public void SearchData1()
    {
        ...
        String url = "http://www.icmpsutrang.esy.es/android_www/getRepairID.php";
		...
		try {
			...
			for(int i = 0; i < data.length(); i++){
    			...
    			map.put("Repair_Id", c.getString("Repair_Id"));
    			map.put("Order_Id", c.getString("Order_Id"));
    			map.put("Repair_Date_In", c.getString("Repair_Date_In"));
    			map.put("Repair_Detail", c.getString("Repair_Detail"));
	        ...
	        SimpleAdapter sAdap;
	        sAdap = new SimpleAdapter(Page4_2.this, MyArrList, R.layout.activity_column_repair,
	               new String[] {"Repair_Id","Cust_Fname","Cust_Lname"}, new int[] {R.id.ColCustomerID, R.id.ColFName, R.id.ColLName});      
			...
			lisView1.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> myAdapter, View myView,
					...
					final String Repair_Id = MyArrList.get(position).get("Repair_Id")
							.toString();
					...
					String strTel = MyArrList.get(position).get("Cust_Tel")
							.toString();
					String strRepair_Date_In = MyArrList.get(position).get("Repair_Date_In")
							.toString();
					String strRepair_Detail = MyArrList.get(position).get("Repair_Detail")
							.toString();
					...
					viewDetail.setMessage("รหัส\t\t\t\t\t\t: " + strCustomerID + "\n"
							...
							+ "นามสกุล	\t\t: " + strLname + "\n" 
							+ "เบอร์โทร	\t\t: " + strTel + "\n" 
							+ "วันที่รับเรื่อง\t: " + strRepair_Date_In + "\n" 
							+ "หมายเหตุ\t\t: " + strRepair_Detail + "\n" 
		                  ...
		                  public void onClick(DialogInterface dialog, int which)
		                  {
		                	  ...
		                	  if ((lat != 0.0)&&(lng != 0.0)){
		                		  ...
		                		  if(((strStoreLati11 != null)&&(strStoreLongi11!= null))){
		                				//ส่งข้อมูลข้ามหน้าจอ
		                			Intent newActivity = new Intent(Page4_2.this,MapMain.class);
									...
									startActivity(newActivity);
		                			 ...
		                			 // Toast.makeText(Page4_2.this,"ไม่ทราบตำเเหน่งต้นทางเข้า", Toast.LENGTH_SHORT).show();
		                		  }else{
			                	  		
		                	  			Toast.makeText(Page4_2.this,"ไม่ทราบตำเเหน่งปัจจุบัน", Toast.LENGTH_SHORT).show();
		                	 }
							}else {
								Toast.makeText(Page4_2.this,"ไม่ทราบตำเเหน่งลูกค้า", Toast.LENGTH_SHORT).show();
							}
		                  }
		                });
					viewDetail.setNeutralButton("อัพเดท", new DialogInterface.OnClickListener()
						...
						private void Update() {
						     		...
						     		String url = "http://www.icmpsutrang.esy.es/android_www/PostRepairUpdate.php";
						     		
						    		List<NameValuePair> params = new ArrayList<NameValuePair>();
						            params.add(new BasicNameValuePair("Repair_status_ch", String.valueOf("Y")));
						            params.add(new BasicNameValuePair("Repair_Id", String.valueOf(Repair_Id)));
									...
									{
										Toast.makeText(Page4_2.this, "อัพเดท สถานะการซ่อมเรียบร้อยเเล้ว", Toast.LENGTH_SHORT).show();
										SearchData1();
									}           
						}
		                });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.page4_2, menu);
        return true;
    }
				...
				
	{
    	        ...
    	        AlertDialog.Builder dialog = new AlertDialog.Builder(Page4_2.this);
    	        ...
    	        dialog.setPositiveButton("ใช่", new OnClickListener() {
    	            public void onClick(DialogInterface dialog, int which) {
            			Intent newActivity = new Intent(Page4_2.this,Login.class);
            			startActivity(newActivity);
    	                finish();
    	            }
    	        });
