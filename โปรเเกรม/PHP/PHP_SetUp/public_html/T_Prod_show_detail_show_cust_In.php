   ...
   <table width="100%" border="0">
        ...
        <tr>
          ...
          <td width="55%" align="right" id="l"><label for="Cust_Password"></label>
            <input name="Cust_Id" type="text" id="Cust_Id" value="<?php echo $NewEID;?>" size="18" readonly="readonly" /></td>
        </tr>
                        <tr>
			      <td width="55%">&nbsp;</td>
      ...
      <div class="col">
	    <table width="267" border="0">
         <tr align="center">
          <th colspan="3" align="center"><p>เพิ่มลูกค้าใหม่ | <a href="T_Prod_show_detail_show_cust_search.php">ค้นหาลูกค้า</a></p>
            <p>&nbsp;</p></th>
        </tr>
         <tr>
