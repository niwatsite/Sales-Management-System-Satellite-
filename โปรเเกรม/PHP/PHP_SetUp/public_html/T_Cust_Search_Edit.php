...
<div id="content">
	<div id="header">
			...
			<div id="pitch">
			  <table width="100%" border="0">
			    ...
			    <tr>
			      <td colspan="3">ลูกค้า&gt;&gt;เเก้ไขข้อมูลลูกค้า</td>
		        </tr>
		      </table>
			</div>
			<p>&nbsp;</p>
  ...
  <form id="form1" method="post" action="T_Cust_Update.php?$Cust_Id=<?=$_GET["Cust_Id"];?>" onSubmit="JavaScript:return fncSubmit();">
    <div id="cols">
      <div class="col">
        ...
        <tr>
          ...
          <td width="55%" align="right" id="l"><label for="Cust_Password"></label>
            <input name="Cust_Fname" type="text" id="Cust_Fname" value="<?=$objResult["Cust_Fname"];?>" size="18" tabindex="1"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td align="right" id="l"><label for="textfield3"></label>
            <input name="Cust_Number" type="text" id="Cust_Number" value="<?=$objResult["Cust_Number"];?>" size="18" tabindex="4"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
          </tr>
        <tr>
          ...
          <td align="right" id="l"><label for="textfield4"></label>
            <input name="Cust_District" type="text" id="Cust_District" value="<?=$objResult["Cust_District"];?>" size="18" tabindex="7"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
          </tr>
        <tr>
          ...
          <td align="right" id="l"><label for="textfield5"></label>
            <input name="Cust_Code" type="text" id="Cust_Code" value="<?=$objResult["Cust_Code"];?>" size="18" tabindex="10"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
          </tr>
	    ...
	    <table width="267" border="0">
			    ...
			    <tr>
			      ...
			      <td><label for="StoreLongi"></label>
			        <input name="Cust_Lname" type="text" id="Cust_Lname" value="<?=$objResult["Cust_Lname"];?>" size="18" tabindex="2"/></td>
		        </tr>
			    <tr>
			    ...
			    <tr>
			      ...
			      <td><label for="textfield4"></label>
			        <input name="Cust_Prefecture" type="text" id="Cust_Prefecture" value="<?=$objResult["Cust_Prefecture"];?>" size="18" tabindex="8"/></td>
		        </tr>
			    <tr>
			      <td colspan="2">&nbsp;</td>
		        </tr>
			    <tr>
			      ...
			      <td><label for="textfield5"></label>
			        <input name="Cust_Tel" type="text" id="Cust_Tel" value="<?=$objResult["Cust_Tel"];?>" size="18" tabindex="11"/></td>
		        </tr>
			    <tr>
			      <td colspan="2">&nbsp;</td>
	      </tr>
	    ...
	    <table width="267" border="0">
			    ...
			    <tr>
			      ...
			      <td width="55%"><label for="StoreLongi"></label>
			        <input name="Cust_Id_Current" type="text" id="Cust_Id_Current" value="<?=$objResult["Cust_Id_Current"];?>" size="18" tabindex="3"/></td>
		        </tr>
			    <tr>
			      <td colspan="2">&nbsp;</td>
		        </tr>
			    <tr>
			      <td>ถนน :</td>
			      <td><label for="textfield3"></label>
			        <input name="Cust_Road" type="text" id="Cust_Road" value="<?=$objResult["Cust_Road"];?>" size="18" tabindex="6"/></td>
		        </tr>
			    <tr>
			      <td colspan="2">&nbsp;</td>
		        </tr>
			    <tr>
			      <td>จังหวัด :</td>
			      <td><label for="textfield4"></label>
		          <input name="Cust_Province" type="text" id="Cust_Province" value="<?=$objResult["Cust_Province"];?>" size="18" tabindex="9"/></td>
		        </tr>
			    <tr>
			      <td colspan="2">&nbsp;</td>
		        </tr>
			    <tr>
			      <td>อีเมล์ :</td>
			      <td><label for="textfield5"></label>
			        <input name="Cust_Email" type="text" id="Cust_Email" value="<?=$objResult["Cust_Email"];?>" size="18" tabindex="12"/></td>
		        </tr>
			    <tr>
			      <td colspan="2">&nbsp;</td>
		        </tr>
