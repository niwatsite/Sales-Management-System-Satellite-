	...
	<div id="header">
			...
			<ul id="menu">
			  <li><a href="Head_admin_home.php">หน้าเเรก</a></li>
				...
				<li><a href="#" class="current">ลูกค้า</a></li>
    ...
    <tr align="center">
      ...
      <th width="298">Keyword :
        <input name="txtKeyword" type="text" id="txtKeyword" value="<?=$_GET["txtKeyword"];?>" size="20" />        <input name="Btn_search" type="submit" id="Btn_search" value="ค้นหา"></th>
	  	<th width="300" align="left"><a href="Cust_In.php">เพิ่มข้อมูล</a></th>
    </tr>
    <tr align="center">
...
?>
      ...
      <td align="center"><?=$objResult["Cust_District"];?></td>
			...
			<td align="center"><a href="Cust_Search_Edit.php?Cust_Id=<?php echo $objResult["Cust_Id"];?>"class="edit">Edit</a></td>
			<td align="center"><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='Cust_Search_De.php?Cust_Id=<?=$objResult["Cust_Id"];?>';}"class="delete">Delete</a></td>
  	</tr>
	<?
	}
	?>
