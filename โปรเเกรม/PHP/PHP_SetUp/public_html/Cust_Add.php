...
$Cust_Id_Current = $_POST['Cust_Id_Current'];
...
$sql="INSERT INTO customers(Cust_Id,Cust_Fname,Cust_Lname,Cust_Id_Current,Cust_number,Cust_Moo,Cust_Road,Cust_District,Cust_Prefecture,Cust_Province,Cust_Code,StoreLati,StoreLongi,Cust_Tel,Cust_Email)VALUES('$Cust_Id','$Cust_Fname','$Cust_Lname','$Cust_Id_Current','$Cust_number','$Cust_Moo','$Cust_Road','$Cust_District','$Cust_Prefecture','$Cust_Province','$Cust_Code','$StoreLati','$StoreLongi','$Cust_Tel','$Cust_Email')";
