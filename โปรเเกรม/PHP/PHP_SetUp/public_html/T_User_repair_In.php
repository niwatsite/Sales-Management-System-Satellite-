...
$maxSQL = "SELECT max(Repair_Id)as MaxEID FROM repair";
...
$Order_Sale_Detail_Id = $_GET['Order_Sale_Detail_Id'];

$strSQL = "SELECT * FROM order_sales NATURAL JOIN customers NATURAL JOIN order_sale_detail NATURAL JOIN products WHERE order_sale_detail.Order_Sale_Detail_Id = '$Order_Sale_Detail_Id'";
...
<div id="content">
  ...
  <form id="frmSearch" method="Post" action="T_User_repair_Add.php" onSubmit="JavaScript:return fncSubmit();">
    <div id="cols">
    ...
    <tr align="center">
      <th colspan="3" align="center"><table width="900" border="0">
        <tr>
          ...
          <td width="170"><label for="NewEID"></label>
...
?>
        ...
        <tr>
          ...
          <td colspan="2" align="center"><label for="Repair_Detail"></label>
            หมายเหตุ(โปรดระบุ)</td>
          </tr>
        <tr>
          <td height="50" colspan="6" align="right"><textarea name="Repair_Detail" id="Repair_Detail" cols="50" rows="30" style="width: 210px; height: 100px;"></textarea></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
